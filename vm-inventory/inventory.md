...
|------|------|--------|------|-----|------|----|-----|
| 108 | Puppetdb | running | 4 | 8GB | 45G | 10.0.0.247 | ssh puppetdb@10.0.0.247 |

## Butternut (10.0.0.202)
| VMID | Name | Status | CPUs | RAM | Disk | IP | SSH |
|------|------|--------|------|-----|------|----|-----|
| 106 | Puppet | running | 4 | 8GB | 64G | 10.0.0.246 | ssh puppet-homelab@10.0.0.246 |
...
| 110 | CLI-Docker | running | 8 | 8GB | 64G | 10.0.0.80 | ssh ubuntu@10.0.0.80 |

## Echo (10.0.0.205)
| VMID | Name | Status | CPUs | RAM | Disk | IP | SSH |
|------|------|--------|------|-----|------|----|-----|
| 100 | Ubuntu-ServerCLI-Template | stopped | 6 | 16GB | 64G | DHCP | N/A (template) |
| 101 | Plex | running | 16 | 64GB | 64G | 10.0.0.155 | ssh bcsb@10.0.0.155 |
| 102 | Ubuntu-Desktop-Template | stopped | 8 | 16GB | 64G | DHCP | N/A (template) |
| 103 | Kali | stopped | 4 | 6GB | 80G | 10.0.0.238 | ssh bcsb@10.0.0.238 |
| 104 | Super-Admin | stopped | 16 | 60GB | 64G | 10.0.0.131 | ssh ubuntu@10.0.0.131 |
| 107 | Qbit | running | 8 | 32GB | 64G | 10.0.0.147 | ssh bcsb@10.0.0.147 |
